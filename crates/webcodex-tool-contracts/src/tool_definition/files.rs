...
pub(super) const SEARCH_DEFINITIONS: &[ToolDefinition] = &[
    ...
    context_recovery_only(model_spec(
        def(
            ...
            false,
            false,
            super::ToolSessionEvidencePolicy::NONE.exploration(super::ToolExplorationEvidence::Search),
        ),
    ...
    adaptive_runtime_direct(
        context_recovery_only(model_spec(
            def(
                ...
                false,
                false,
                super::ToolSessionEvidencePolicy::NONE.exploration(super::ToolExplorationEvidence::SearchBatch),
            ),
...
pub(super) const READ_DEFINITIONS: &[ToolDefinition] = &[
    context_recovery_only(model_spec(
        def(
            ...
            false,
            false,
            super::ToolSessionEvidencePolicy::NONE.exploration(super::ToolExplorationEvidence::Read),
        ),
    ...
    adaptive_runtime_direct(
        context_recovery_only(model_spec(
            def(
                ...
                false,
                false,
                super::ToolSessionEvidencePolicy::NONE.exploration(super::ToolExplorationEvidence::ReadBatch),
            ),

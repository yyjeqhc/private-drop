...
pub(super) const SUMMARY_DEFINITIONS: &[ToolDefinition] = &[
    context_recovery_only(change_summary_like(git_like(model_spec(
        def(
            ...
            false,
            false,
            super::ToolSessionEvidencePolicy::NONE.diff_review(super::ToolDiffReviewEvidence::Always),
        ),
    ...
    adaptive_runtime_direct(
        context_recovery_only(change_summary_like(git_like(model_spec(
            def(
                ...
                false,
                false,
                super::ToolSessionEvidencePolicy::NONE.diff_review(super::ToolDiffReviewEvidence::ArgumentBool("include_diff")),
            ),

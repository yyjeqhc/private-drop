...
`ui://webcodex/agent-continuation/v6` and `ui://webcodex/goal-plan/v2` resources.
The old v1 URIs and Agent continuation v2/v3/v4/v5 are hidden read aliases serving the same current templates;

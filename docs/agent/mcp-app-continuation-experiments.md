...
`ui://webcodex/agent-continuation/v8` and `ui://webcodex/goal-plan/v2` resources.
The old v1 URIs and Agent continuation v2/v3/v4/v5/v6/v7 are hidden read aliases serving the same current templates;

...
Repository first-party dogfood continues to consume the local SDK source, while
external projects generated by `plugin init` consume the exact public npm package.
This preserves deterministic repository CI without making normal validation depend
